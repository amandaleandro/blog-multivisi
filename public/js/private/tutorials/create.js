$(function(){
    ...
    // form send
    $('#form_tutorials').submit(function(){         
        var error = false,
            listYtb = [],
            listSeo = [];
        ...
        if(!error){
            $(this).ajaxSubmit({
                ...
                data: { jController: "admin-panel", admAction: "tutorials", tutorial_video: listYtb, tutorial_seo_tags: listSeo},
                dataType: "json",
                success: function(rest) {
                    if(rest[1] == 'accept'){
                        location.href = '?page=tutorials';
                    }
                }
            });
        }else{
