...
require($_SERVER['DOCUMENT_ROOT'].'/libs/PHPMailer/Exception.class.php');
require($_SERVER['DOCUMENT_ROOT'].'/libs/PHPMailer/PHPMailer.class.php');
require($_SERVER['DOCUMENT_ROOT'].'/libs/PHPMailer/POP3.class.php');
require($_SERVER['DOCUMENT_ROOT'].'/libs/PHPMailer/SMTP.class.php');
require($_SERVER['DOCUMENT_ROOT'].'/libs/PHPMailer/OAuth.class.php');

/**
 * Email [ MODEL ]
 * Modelo responável por configurar a PHPMailer, validar os dados e disparar e-mails do sistema!
 * 
 * @copyright (c) 2017, Pablo R. Araujo Sousa
 */
class Email {
    ...
    private function sendMail() {
        if ($this->Mail->Send()):
            $this->Error = ['Obrigado por entrar em contato. Responderemos em breve.', WS_ACCEPT];
            $this->Result = true;
        else:
