<?php
  $file = $navAdm->getDado()['tutorial_files'][0];
?>
<form action="" method="post" id="form_file" enctype="multipart/form-data">

  <input type="hidden" name="action" value="<?= ($file['archives_id'] ? 'update_file' : 'create_file') ?>">
  <input type="hidden" name="archives_id" value="<?= ($file['archives_id'] ? $file['archives_id'] : '0') ?>">
    ...
    <div class="tab-content" id="v-pills-tabContent">
      <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
        <label class="w-100 mb-4 position-relative">
          Nome do Arquivo
          <input type="text" name="archives_name" class="form-control rounded-0 name_prod" maxlength="75" value="<?= $file['archives_name'] ?>">
            ...
            <label class="w-100">
              ...
              <div class="input-group mb-3">
                ...
                <div class="custom-file">
                    <input type="file" class="custom-file-input fileprod" id="inputGroupFile01"  aria-describedby="inputGroupFileAddon01" accept="application/pdf" name="archives_url">
        ...
        <p class="m-0 text-muted sizeupload">Size: <?= ($file['archives_id'] ? $file['archives_size'] : '0') ?> KB</p>
        </div>
      </div>
    </div>
    <label class="position-relative mt-5">
        <input type="submit"  value="Salvar o Arquivo" class="btn btn-primary rounded-0 pr-5" id="inputSub">
