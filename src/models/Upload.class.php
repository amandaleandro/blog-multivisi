 ...
 * 
 * @copyright (c) 2017, Rodrigo A. Magalhaes
 */
class Upload {
    ...
    function __construct($BaseDir = null) {
        self::$BaseDir = ( (string) $BaseDir ? $BaseDir : '../assets/upload/');
        $dir = explode('/',self::$BaseDir);
     ...
     * @param STRING $Name = Nome da imagems ( ou do blog )
     ...
     * @param STRING $Name = Nome do arquivo ( ou do blog )
     * @param STRING $Folder = Pasta personalizada
     ...
     * @return STRING $Error = Array associatico com o erro
     */
    ...
    private function UploadImage() {
       ...
       switch ($this->File['type']):
        ...
        if (!$this->Image):
            $this->Result = false;
            $this->Error = 'Tipo de arquivo inválido, envie imagens JPG, PNG';
        else:
