...
<div class="container-fluid mt-3">
  ...
  <tbody class="text-muted">
    <?php if(!empty($files)): foreach($files as $file): ?>
      <tr>
        <th scope="row" class="text-center"><?= $file['id_prodarchive'] ?></th>
        <td class="text-center"><?= $file['prodarchives_name'] ?></td>
        <td><?= $file['prodarchives_size'] ?></td>
        <td class="actionicon">
            <a href="?page=files_product/create/<?= $file['id_prodarchive'] ?>" class="text-secondary mr-1"><i class="fad fa-pencil"></i></a>
            <a href="#" class="text-secondary"><i class="fad fa-trash-undo trash" data-id="<?= $file['id_prodarchive'] ?>" data-toggle="modal" data-target="#exampleModal" data-name="<?= $file['prodarchives_name'] ?>"></i></a>
        </td>
      </tr>
      ...
      <div class="modal-body">
        <div class="media">
          ...
          <div class="media-body text-muted">
            ...
            Você tem certeza deseja excluir o arquivo ? <br/><i>Ele pode estar associado a um produto. </i>
          </div>
      </div>
      </div>
